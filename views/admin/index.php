        ...
        [
            ...
            'buttons' => [
                'resend_password' => function ($url, $model, $key) {
                    if (\Yii::$app->user->identity->isSuperUser && !$model->isSuperUser) {
                        return '
                ...
                'switch' => function ($url, $model) {
                    if(\Yii::$app->user->identity->isSuperUser && $model->id != Yii::$app->user->id && Yii::$app->getModule('user')->enableImpersonateUser) {
